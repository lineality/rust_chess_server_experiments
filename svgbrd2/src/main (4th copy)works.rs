...
1. function should add a new first column to chessboard_state
which counts down from 8 to zero from the top

2. function should add a new bottom row to chessboard_state
which is
        ['', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H'],


3. the background for this new column and row should all be dark grey
the font color for the new column and row should be all light grey

4. fix colors part 1: two different colors
the black pieces should be red, the white colors should be
pale green

5. the dark or lite shade of each color should be counter
