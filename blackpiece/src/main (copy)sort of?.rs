...
fn generate_black_oriented_chessboard(chessboard: &[[char; 8]; 8]) -> String {
    let mut doc = Document::new()
        .set("width", "500")  
        .set("height", "500")  
        .set("viewBox", (0, 0, 500, 500))
        .set("style", "background-color: #9e0b00;");  // Set background to dark red
...
fn main() {
    ...
    let svg_code = generate_black_oriented_chessboard(&chessboard_state);
